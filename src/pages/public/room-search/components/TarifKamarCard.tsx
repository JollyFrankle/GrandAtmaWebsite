...
export default function TarifKamarCard({
    ...
    return (
        <Card className="shadow-lg mb-8 lg:grid grid-cols-3 overflow-auto">
            ...
            <div className="col-span-2">
                <CardHeader className="md:flex flex-row justify-between items-center pb-2">
                    ...
                    <Button variant="link" className="!mt-0 -me-2" asChild>
                        <Link to={`/kamar/${item.jenis_kamar.id}`}>Detail kamar <ArrowRightIcon className="ms-2 w-4 h-4" /></Link>
                    </Button>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="block md:flex justify-between items-end">
                        ...
                        <div className="flex border rounded overflow-auto items-stretch">
